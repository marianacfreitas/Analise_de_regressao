...
No gráfico acima podemos observar os efeitos dos fenômenos naturais *El Niño* e *La Niña* na captura de peixes por unidade de esforço. Notamos que durante o fenômeno *La Niña*, caracterizado pelo resfriamento das águas do Pacífico, causa uma significativa diminuição na captura, apresentando menor mediana e variabilidade nessa variável. Já o *El Niño*, que provova um aumento na temperatura das águas do pacífico, gera um leve aumento na captura quando comparado à ausência de fenômenos naturais, com variabilidade um pouco maior.
...
Ao executar esse processo aplicado aos dados de pesca no R, obtemos que as variáveis presentes no modelo para descrever a variável `cpue2` são frota, latitude, longitude e fenômeno, com coeficientes 0.20857, -0.12413, -0.44620 (em caso de *La Niña*) e 0.09949 (em caso de *El Niño*, respectivamente). 
